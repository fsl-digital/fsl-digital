          ...
          <div className="container-custom">
            ...
            {lang === 'de' ? (
              <div className="prose max-w-none">
                <div className="mb-12 bg-gray-50 border-l-4 border-primary p-8 rounded-r-lg text-left">
                ...
                <div className="my-6 flex flex-col items-center">
                  <img
                    ...
                    onClick={openZoom}
                  />
                  <p className="text-xs text-gray-600 italic mt-2 text-center">Own graphic CC BY-SA 4.0 | FSL digital</p>
                </div>
        ...
        {zoomOpen && (
          ...
          >
            <div className="relative p-2">
              ...
              />
              <p className="text-center text-sm text-gray-300 mt-3">{lang === 'de' ? 'Eigene Graphik CC BY-SA 4.0 | FSL digital' : 'Own graphic CC BY-SA 4.0 | FSL digital'}</p>
            </div>
          </div>
        )}
      </main>
